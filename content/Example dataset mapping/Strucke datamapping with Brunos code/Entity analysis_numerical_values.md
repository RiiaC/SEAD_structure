---
publish: true
permalink: /Example dataset mapping/Strucke datamapping with Brunos code/Entity analysis_numerical_values.md
---
...
>   In the case of the pMC\_error, they will be assigned a `qualifer`based either on:
