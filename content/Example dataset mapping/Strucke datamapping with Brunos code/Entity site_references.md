---
publish: true
permalink: /Example dataset mapping/Strucke datamapping with Brunos code/Entity site_references.md
---
...
- [x] remove duplicates based on site\_id
- [x] add an extra column:
  \`full\_reference: '{forfattare} {tryckar} {titel} {tidskrift} {forlagsort}'
- [x] join to [[Example dataset mapping/Strucke datamapping with Brunos code/Entity site|Entity site]] on [[site_id]]
- [x] join to [[Example dataset mapping/Strucke datamapping with Brunos code/Entity biblio|Entity biblio]] on `fid`
