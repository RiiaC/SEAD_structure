...
- [ ] needs a connection to [[content/Example dataset mapping/Strucke Data mapping/first draft of dataset/Entity methods|Entity methods]]
- [ ] later, when Sakarias and colleagues publish the paper based on this dataset, it can be added and linked with the foreign key bibilo_id for that paper in [[content/Example dataset mapping/Strucke Data mapping/Entity biblio|Entity biblio]]
